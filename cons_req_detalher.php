...
<h1 class="lj">Detalhamento Requisição</h1></br>
	...
	?>
				...
				require "bd.php"; 
				//echo $nrcarga;				
				$sqlo = "select e.nrocarga seqpedido,b.descsetor,a.seqproduto,c.desccompleta,sum(a.qtde) QTDE,d.embalagem QTDEMB,a.embalagem from consinco.imp_pedcd_temprequisicao a, consinco.imp_pedcd_setores b, consinco.map_produto c, consinco.map_famembalagem d, consinco.imp_pedcd_cargareq e where e.nrocarga = ".$nroreq." and a.seqsetor = b.seqsetor and a.seqproduto = c.seqproduto and c.seqfamilia = d.seqfamilia and a.embalagem = d.qtdembalagem and a.seqpedido = e.seqpedido and a.seqproduto = e.seqproduto group by e.nrocarga,b.descsetor,a.seqproduto,c.desccompleta,d.embalagem,a.embalagem order by 4";
				//echo $sqlo;
