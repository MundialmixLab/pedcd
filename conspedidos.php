...
<div id="formulario">
	...
	<h1 class="lj">Consulta Requisições</h1></br></br>
		</br></br>
			
	<form method="post" action="#" enctype="multipart/form-data" name="sitreq" >
		<select name="ssitreq" id="ssitreq" class="csitreq" onchange='fconsreq(this.value)'>
	...
	<div id="resultadoim">
	<input id="imprime" type="button" name="print" value="" onclick="btimp2()" >	
	</form>
	</div>
